...
const report_page = () => {
    ...
    return (
        <div className='min-h-screen px-14 bg-[#082854] mt-[70px] w-full flex flex-col justify-center items-center'>
            <div className='grid w-full mt-10 md:w-[80vw] lg:w-[70vw] grid-cols-1 rounded-lg md:grid-cols-2'>
            ...
            {recordFound &&
                <div className='grid text-white py-8 px-3 mb-9 max-w-[500px] w-full grid-cols-1 items-center gap-3'>
                    <h1 className='text-3xl text-center mb-4 font-bold'>Car Details</h1>
